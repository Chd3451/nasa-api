<h1 align="center"><b>Welcome to the presentation of your NASA.api app. </b><img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<!-- Info-->
<p align="center">
...
<h4>
This is our application about Nasa having as references<br>
  the latest news about space and the solar zone,<br>
  this app is divided as the previous projects by sections<br>
  where you will find the news from the latest<br>
  to the previous according to the scroll.
  <br><br>
This project is a little different from the previous one <br>
  because it is directly modified by atomizing all the <br>
  components such as the headder, homescreen and all the files.

<br><br>


<br><br><br>
<img src="https://github.com/JeffersonHidalgo/Readme-Doc2/blob/main/IMG-20231121-WA0018.jpg?raw=true" width="200" height="340" style="float: left;">
